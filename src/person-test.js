...
describe("Person", function() {
  ...
  it('should have a name and a dog', function() {
    ...
    // 2 args: firstName, dog - need 2 params in constructor
    assert.equal(trisha.name, 'Trisha');
    //this.name property - value: 1st argument
    assert.instanceOf(trisha.dog, Dog);
    //this.dog - should be a dog object
    assert.equal(trisha.dog.name, 'Luna');
    //this.dog.name = dogDetails.name;
  })
  ...
  it('should notice when dog no longer wants to play', function() {
    ...
    //new dog connie with energyLevel of 5
    ...
    // throw ball twice and call the method twice
